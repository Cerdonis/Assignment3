...
orig1 = imread('undistorted00000106.jpg');
orig2 = imread('undistorted00000109.jpg');

K = readmatrix('Calibration.txt');

ext1 = readmatrix('camera00000106.txt');
ext2 = readmatrix('camera00000109.txt');
...
[im1_crop, top1, bot1] = CROP(im1);
[im2_crop, top2, bot2] = CROP(im2);
